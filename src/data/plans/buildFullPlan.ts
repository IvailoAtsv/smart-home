    ...
    return [
      {
        ...
        power: {
          label: "5 V USB-C",
          detail:
            "По време на прошивката — към компютър с Chrome. После — USB адаптер в контакт, за да стои постоянно включен.",
        },
        images: [
          {
            ...
            caption:
              "ATOM Echo · USB-C с данни за прошивка, после постоянно 5 V",
          },
        ],
        setup: [
          line(
      ...
      },
      {
        ...
        summary:
          "От Chrome на компютър записваш Voice Assistant firmware, свързваш ATOM Echo към 2.4 GHz Wi-Fi и го добавяш към Home Assistant. После избираш гласовия pipeline.",
        help: [
          {
        ...
        images: [
          {
            ...
            caption: "Прошивка само през Chrome на desktop (Web Serial)",
          },
        ],
        setup: [
          ...
          "Избери Install Voice Assistant и изчакай прошивката.",
          ...
          line(
            "Add to Home Assistant → приеми ESPHome. Pipeline-а избираш в ",
...
- осветлението в хола`,
    ...
    ...voiceSteps,
    {
      ...
      summary: `На HA OS инсталираш voice apps (Whisper и по желание Piper), връзваш ги през Wyoming и казваш на ${primary} кой Assist pipeline да ползва. Това е „мозъкът“ на разговора.`,
      help: [
        {
      ...
      images: [
        {
          ...
          caption: "Гласов pipeline · от wake word до лампата",
        },
      ],
      setup: [
        ...
        `От Settings → Voice assistants създай pipeline с Home Assistant conversation agent, STT = Whisper, език Bulgarian и по желание TTS = Piper. Присвои pipeline-а към ${primary}.`,
      ...
      images: [
        {
          ...
          alt: "Okay Nabu → слуша → българска команда",
          caption: "Първо wake word (EN), после командата (BG)",
        },
      ],
      setup: [
        `В настройките на ${primary} / Assist избери wake word — „Okay Nabu“ или „Hey Jarvis“ са добри стартове.`,
...
Системата: тишина → Whisper → лампата → потвърждение`,
    ...
    },
    {
      ...
      summary:
        "Nabu Casa е резервен вариант само за разпознаване/TTS, ако локалният Whisper не стига. Shelly и автоматизациите си остават в къщата. Връзката за абонамент е в списъка от първата стъпка.",
      setup: [
          ...
          ? [
              {
                ...
                description:
                  "Chrome на desktop — същият guide като в тестовия план.",
              },
            ]
          : undefined,
...
function expandSummary(prefs: UserPrefs): string {
  ...
  const roomHint =
    rooms <= 1
      ? "Когато холът е стабилен, повтаряш същия рецепт за следващите стаи."
      : `Планираш около ${rooms} стаи — повтаряш рецепта стая по стая, не всичко наведнъж.`;
