...
function cloudBuyGroup(): BuyGroup {
  return {
    ...
    title: "По избор · Cloud глас за първия тест",
    description:
      "Най-малко настройване: Home Assistant Cloud предоставя STT/TTS. Можеш да го пропуснеш, ако ще настройваш локална гласова верига.",
    items: [
      {
        id: "test-nabu-casa",
...
function vmSetupSteps(os: ActiveTestOs, strategy: VoiceStrategy): SetupLine[] {
  ...
  if (os === "macos") {
    return [
      line(
        ...
        " и изтегли ARM64 образ на Home Assistant OS от https://www.home-assistant.io/installation/macos/.",
      ),
  ...
  if (os === "windows") {
    return [
      line(
        ...
        stepRef("overview", "стъпка 1"),
        ". Изтегли Generic x86-64 образ на Home Assistant OS от https://www.home-assistant.io/installation/generic-x86-64/.",
      ),
  ...
  return [
    line(
      ...
      stepRef("overview", "стъпка 1"),
      ". Изтегли Generic x86-64 образ на HAOS от https://www.home-assistant.io/installation/generic-x86-64/.",
    ),
    ...
    return [
      {
        ...
        setup: [
          ...
          line(
            "В настройките му избери гласовата верига от ",
  ...
  return [
    {
      ...
      power: {
        label: "5 V USB-C",
        detail:
          "По време на инсталацията — към компютъра с Chrome. После — USB адаптер в контакт.",
      },
      images: [
        {
    ...
    },
    {
      ...
      summary:
        "От Chrome на компютър инсталираш Voice Assistant, свързваш ATOM Echo към 2.4 GHz Wi-Fi и го добавяш към временния Home Assistant.",
      help: [
        {
      ...
      images: [
        {
          ...
          caption: "Инсталация през Chrome на компютър",
        },
      ],
      setup: [
        ...
        line(
        "Add to Home Assistant → ESPHome. Избери гласовата верига от ",
          stepRef("pipeline", "Гласова верига"),
          ".",
        ),
      ],
      warnings: [
        "Мобилни браузъри не поддържат Web Serial за тази инсталация.",
...
export function buildTestPlan(prefs: UserPrefs): InstallPlan | null {
  ...
  const steps: Omit<RoadmapStep, "step">[] = [
    ...
    {
      id: "ha-stack",
      title: "Завърши HA и избери гласова верига",
      summary:
    ...
    },
    {
      ...
      summary: `Проверяваш, че Assist има работеща гласова верига. Без нея ${primary} може да чуе wake word, но Home Assistant няма да знае как да превърне говора в команда.`,
      help: [
        {
          href: "/help/voice-pipeline",
      ...
      setup: [
        ...
        `Запиши името на гласовата верига — ще я избереш на ${primary} след като го добавиш.`,
      ],
      code: [
        {
      ...
      warnings: [
        "Ако облачната гласова верига не се появява, провери, че Home Assistant Cloud е активиран и че VM има интернет.",
      ],
    },
    {
      id: "shelly-ha",
...
- осветлението в хола`,
    ...
    ...voiceSteps,
    {
      ...
      setup: [
        `В настройките на ${primary} / Assist избери wake word, например „OK, Nabu“ или „Hey Jarvis“.`,
        ...
        "Замълчи. Системата засича тишина (VAD) и изпраща аудиото към гласовата верига.",
...
Системата: тишина → гласова верига → автоматизация → лампата светва`,
        },
      ],
    },
    {
      ...
      setup: [
        ...
        `Тествай пак с текст, после с глас през ${primary}.`,
      ],
      code: [
        {
